...
// blog
class kufa_Widget_Blog extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Latest Blog', 'kufa' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => 'ASC',
            'options' => [
               'ASC'  => __( 'Ascending', 'kufa' ),
               'DESC' => __( 'Descending', 'kufa' )
            ],
         ]
      );
              ...
              <div class="col-lg-4 col-md-6">
                <div class="single-blog-post mb-30">
                    <div class="b-post-thumb">
                      <a href="<?php the_permalink() ?>"><img src="<?php echo get_the_post_thumbnail_url( get_the_ID(),'kufa-404x302'); ?>" alt="<?php the_title() ?>"></a>
                    </div>
...
Plugin::instance()->widgets_manager->register_widget_type( new kufa_Widget_Blog );